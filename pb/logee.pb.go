...
/*
Package logee is a generated protocol buffer package.
...
func init() {
	proto.RegisterType((*PushRequest)(nil), "logee.PushRequest")
	proto.RegisterType((*PushResponse)(nil), "logee.PushResponse")
}
...
func (c *logeeClient) PushLog(ctx context.Context, in *PushRequest, opts ...grpc.CallOption) (*PushResponse, error) {
	...
	err := grpc.Invoke(ctx, "/logee.Logee/PushLog", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Logee_PushLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/logee.Logee/PushLog",
	}
...
var _Logee_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "logee.proto",
}

func init() { proto.RegisterFile("logee.proto", fileDescriptor0) }

var fileDescriptor0 = []byte{
	// 148 bytes of a gzipped FileDescriptorProto
	,
}
